...
//	Function that add a submission shortcode anywhere to display the form submissions on the front-end
...
//	Function that searches if the styling exists for a form and return if it exist
...
//	Function that checks if the styling exists for any form
