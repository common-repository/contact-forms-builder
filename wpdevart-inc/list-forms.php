<?php
/**
 * Form List gets all generated form from the database
 *
	...
	<div class="wpdevart-general-form" method="post" action="">
		...
		<?php require_once( wpda_form_PLUGIN_DIR .'/wpdevart-layout/sidebar.php');?>
			<main class="pull-left">
				...
				<?php 
				  //	Showing contact forms with pagination
							...
							<?php
							   ...
							   ?>
								<div class="addFormBox <?php echo $box_class;?>" id="addForm-<?php echo $wpdevart_form->id; ?>">
									...
									<div class="col-md-4 col-sm-4 ">
										<input class="form-credentials form-control" onclick="this.select()" value="<?php echo "[wpdevart_forms id=".$wpdevart_form->id."]"; ?>" readonly data-trigger="focus" data-toggle="tooltip" data-placement="bottom" data-title="Copy this shortcode and paste it anywhere you want to display this form." >
									</div>
							  ...
							  <?php 
								...
								<div >
									...
									<a  href='<?php echo admin_url("admin.php?page={$this->slug['add_new']}"); ?>' style="color:#7052fb; font-weight:bold">Create a new form</a>
								</div>
                                <br />
								<?php
							  }  //	total >0
