<?php
/**
 * Lists all form submissions of the relevant form
 *
				...
				<div class="tab-content wpdevart-tabs"> 
					<div role="tabpanel" class="tab-pane fade active in" id="form-styling">
						...
						if($form_fields) {	
							...
							<a class="wpdevart_pro btn green margin-left-10 pull-right margin-bottom-20 btn_export_records" name="btn_export_records" data-toggle="modal" data-target="#export-records">Export Records to CSV<span class="wpdevart_pro_span">(PRO)</span></a>
								...
								<div class="table-condensed-outer">
								   <table id="show_submissions_table" class="col-md-12 table-bordered table-striped table-condensed cf">
									   <thead class="cf">
										...
										<tbody><?php
                                        // Find the record of submitted contact forms
