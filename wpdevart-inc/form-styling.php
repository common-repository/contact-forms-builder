...
/*
  ...
  There are multiple ways in which CSS  styles  are applied to our form , that are :
    ...
    3 . General styling for all forms (created by our plugin) [static  form_id = -1 ]
		--NOTE--  please note that form with id = -1 do not exists in database . It is just a static id that
		      	  used only in styling purposes 
				  general form styling has been DEPRECATED
  ...
  NOTE: please note that custom styling for WpDevArt Forms is stored in WordPress 
  		table named "wp_options" with our defined option of "wpdevart_forms_style"
*/
